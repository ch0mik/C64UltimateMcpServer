...
public static class C64ResourceCatalog
{
    ...
    [
        ...
        new("c64://examples/index", "examples", "index", "C64 Embedded Example Index", "MCP resource index for embedded C64 BASIC and assembly examples.", "text/markdown", ["examples", "index.md"], ["examples", "source", "reference"]),
        new("c64://examples/game-demo-patterns", "examples", "game-demo-patterns", "Game And Demo Pattern Notes", "Embedded MCP notes for C64 game and demo patterns derived from MIT-licensed source examples.", "text/markdown", ["examples", "game-demo-patterns.md"], ["examples", "cc65", "assembly", "reference"]),
        new("c64://examples/assembly/dreadline-fastscroll-generator", "examples", "assembly/dreadline-fastscroll-generator", "Dreadline Fastscroll Generator Example", "Dreadline-derived row fastscroll adapted to compile with the built-in assembly PRG generator.", "text/plain", ["examples", "assembly", "dreadline-fastscroll-generator.asm"], ["examples", "assembly", "scroll", "compiled"]),
        ...
        new("c64://examples/assembly/hires-fire-line-demo", "examples", "assembly/hires-fire-line-demo", "HIRES Fire Line Demo", "Embedded upstream HIRES line/fire demo source; reference material that depends on the line draw library resource.", "text/plain", ["examples", "assembly", "hires-fire-line-demo.asm"], ["examples", "assembly", "graphics", "reference"]),
        new("c64://examples/assembly/hello-world-kernal", "examples", "assembly/hello-world-kernal", "KERNAL Hello World Assembly Example", "Adaptation of an upstream C64 assembly hello world example for the built-in assembly PRG generator.", "text/plain", ["examples", "assembly", "hello-world-kernal.asm"], ["examples", "assembly", "source"]),
        new("c64://examples/assembly/hires-dot-burst-generator", "examples", "assembly/hires-dot-burst-generator", "HIRES Dot Burst Generator Example", "HIRES fire/line demo idea adapted to compile with the built-in assembly PRG generator.", "text/plain", ["examples", "assembly", "hires-dot-burst-generator.asm"], ["examples", "assembly", "graphics", "compiled"]),
        new("c64://examples/assembly/hires-line-draw-library", "examples", "assembly/hires-line-draw-library", "HIRES Line Draw Library", "Embedded upstream HIRES line drawing and dot stepping library reference.", "text/plain", ["examples", "assembly", "hires-line-draw-library.asm"], ["examples", "assembly", "graphics", "library"]),
        new("c64://examples/basic/token-control-codes", "examples", "basic/token-control-codes", "BASIC Token And Control Codes Example", "Adaptation of an upstream C64 BASIC tokenization example for the built-in BASIC PRG generator.", "text/plain", ["examples", "basic", "token-control-codes.bas"], ["examples", "basic", "source"]),
        new("c64://sources/classic-c64-references", "sources", "classic-c64-references", "Classic C64 Reference Provenance", "Provenance notes for classic C64 books and manuals used to curate embedded MCP resources.", "text/markdown", ["sources", "classic-c64-references.md"], ["sources", "reference", "okf"]),
